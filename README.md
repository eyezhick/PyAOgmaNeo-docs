...
| Common workflows | [Hierarchy Usage Patterns](docs/api_reference/hierarchy.md#usage-patterns-and-examples) |
...
|------|---------|-------------|
| 2025-08-01 | [Hierarchy Usage Patterns](docs/api_reference/hierarchy.md#usage-patterns-and-examples) | Comprehensive guide covering training workflows, sequence processing, and reinforcement learning patterns |
...
- [Usage Patterns](docs/api_reference/hierarchy.md#usage-patterns-and-examples) ✅
